...
pub async fn update_bio(uid: &Uuid, pool: &PgPool, bio: &String) -> Result<(), Box<dyn std::error::Error>> {
...
pub async fn update_display_name(uid: &Uuid, pool: &PgPool, display_name: &String) -> Result<(), Box<dyn std::error::Error>> {
